...
app.get('/scrape', function(req, res) {
  ...
  request('http://nutritionfacts.org/videos/', function(error, response, html) {
    ...
    $('h3').each(function(i, element) {
    		...
    		// save an empty result object
				...
				// grab video image
				result.vidimage = $(this).parent().children('a').children('div').children('img').attr('data-lazy-src');
